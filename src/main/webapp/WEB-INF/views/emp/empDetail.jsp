...
.modal:not(#openModal) .modal-cont {padding: 60px 40px 40px;}
.modal:not(#openModal) #pdf_btn {position: absolute; top: 15px;}
	        ...
	        success: function(data) {
	            ...
	            data.forEach(mFormVO => {
	                ...
	                if (mFormVO.docNm === '재직증명서') {
	                    str += `<td><button type="button" class="btn5 docBtn" modal-id="modal-name1"><i class="xi-download"></i></button></td>`;
	                } else if (mFormVO.docNm === '급여명세서') {
	                    str += `<td><button type="button" class="btn5 docBtn" modal-id="modal-name2"><i class="xi-download"></i></button></td>`;
	                } else {
	                    str += `<td></td>`; 
	                }
	                }
