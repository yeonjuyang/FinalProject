...
<script>
            $(function () {
            	...
            	//대시보드의 순서 처리
            	let ordStr = "${dashboardVO.dashOrder}";
            	...
            	fSort();
            	//대쉬보드 위치 저장하기
        		$("#settingBtn").on("click",function(){	//2,3,4,1,5,6,7,8,9 => 4,1,2,3,5,6,7,8,9
        			//data-order의 값 넣어주기(DB에서 가져옴)
        			let str = "";
        			let num1 = $("#d1").attr	
        	    	...
        	    	$(".wf-box.custom").each(function(idx){
        	    		//let ord = $(this).attr("id").substr(-1,1);
        	    		if($(this).attr("id") == "d1"){
        	    			ordInt1 = idx + 1
        	    			ord1 = ordInt1 + "";
        	    		}
        	    		...
        	    		str = ord1 + "," + ord2 + "," + ord3 + "," + ord4 + "," + ord5 + "," + ord6 + "," + ord7 + "," + ord8 + "," + ord9;
    			    ...
    			    draggables.forEach((draggable) => {
    			        ...
    			        draggable.addEventListener("dragend", () => {
    			            draggable.classList.remove("dragging");
    			             /* alert($(".wf-box-wrap").children().eq(0).data('order'));
    			             alert($(".wf-box-wrap").children().eq(1).data('order'));
    			             alert($(".wf-box-wrap").children().eq(2).data('order'));
    			             alert($(".wf-box-wrap").children().eq(3).data('order'));
    			             alert($(".wf-box-wrap").children().eq(4).data('order'));
    			             alert($(".wf-box-wrap").children().eq(5).data('order'));
    			             alert($(".wf-box-wrap").children().eq(6).data('order'));
    			             alert($(".wf-box-wrap").children().eq(7).data('order'));
    			             alert($(".wf-box-wrap").children().eq(8).data('order'));
    			             alert($(".wf-box-wrap").children().eq(9).data('order')); */
    			        });
    			    });
...
<div class="wf-box-wrap">
    ...
    <!-- ================================================== -->
    <!-- 프로젝트 -->
    <div class="wf-box custom" draggable="true" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="" data-order="2" id="d2">
        <div class="tit-wrap">
            <div class="tit-wrap-inner">
    ...
    <!-- ================================================== -->
    <!-- 업무 -->
    <div class="wf-box custom" draggable="true" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="" data-order="3" id="d3">
        <div id="dutyBox"></div>
    </div>

    <!-- ================================================== -->
    <!-- 메일 -->
    <div class="wf-box custom" draggable="true" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="" data-order="4" id="d4">
        <div class="tit-wrap">
            <div class="tit-wrap-inner">
    ...
    <!-- ================================================== -->
    <!-- 공지사항 -->
    <div class="wf-box custom" draggable="true" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="" data-order="5" id="d5">
    ...
    <!-- ================================================== -->
    <!-- 진행중인 결재-->
    <div class="wf-box custom" draggable="true" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="" data-order="6" id="d6">
        <div class="tit-wrap">
            <div class="tit-wrap-inner">
    ...
    <!-- ================================================== -->
    <!-- 오늘의 일정 -->
    <div class="wf-box custom" draggable="true" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="" data-order="7" id="d7">
        <div class="tit-wrap">
            <div class="tit-wrap-inner">
    ...
    <!-- ================================================== -->
    <!-- IT 뉴스 -->
    <div class="wf-box custom" draggable="true" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="" data-order="8" id="d8">
        <div class="tit-wrap">
            <div class="tit-wrap-inner">
    ...
    <!-- ================================================== -->
    <!-- 회의실 예약 현황 -->
    <div class="wf-box custom" draggable="true" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="" data-order="9" id="d9">
        <div class="tit-wrap">
            <div class="tit-wrap-inner">
