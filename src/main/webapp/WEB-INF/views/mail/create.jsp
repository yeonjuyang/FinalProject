...
<div class="wf-mail-wrap">
   <!-- 메일 왼쪽 파트 -->
   <div class="wf-content-area wf-mail-left" data-aos="fade-right" data-aos-duration="700" data-aos-delay="0">
   ...
   <!-- 메일 오른쪽 파트 -->
   <div class="wf-mail-right" data-aos="fade-right" data-aos-duration="700" data-aos-delay="200">
            ...
            <form method="post" enctype="multipart/form-data">
               <div class="wf-tit-wrap">
                  ...
                  <div class="side-util" style="justify-content: right;">
                     <button type="button"
                        class="btn1" id="autoFill">자동완성</button>
                     <button type="submit"
               ...
               <ul class="wf-insert-form3">
                  ...
                  <li>
                     <div class="wf-insert-tit">
                        <label>제목</label> <input type="text" name="emailSj" id="emailSj"
                  ...
                  <li><textarea name="emailCn" class="editor"
                        placeholder="Editing with Markdown output"></textarea></li>
...
function autoFill(){
   var autoRecipient = `<span class="wf-badge2"><div class='dynamic-div' data-empno='2020015'>dae1234@google.com(김대덕)<button type="button" class="del-btn empDelete"><i class="xi-close"></i></button></div></span>`;
   var autoSj = "[업무 협조 요청]";
   var recipientList = $("#recipientList");
   var emailSj = $("#emailSj");
   
   recipientList.append(autoRecipient);
   emailSj.val(autoSj);
}
