...
public class ArticlePageForSenderMain<T> {
   // 전체 글 수
   private int total;
   // 현재 페이지 번호
   ...
   public ArticlePageForSenderMain(int total, int currentPage, int size, List<T> content, String keyword) {
      ...
      if (total == 0) {
        ...
        pagingArea += " href='javascript:getDutyListForSender(" + (this.startPage-4) + ", " + keyword + ")'>";
        ...
        pagingArea +="'>";
        pagingArea += "<a class='page-link' href='javascript:getDutyListForSender(" + pNo + ", " + keyword + ")'>" + pNo + "</a>";	
        pagingArea += "</li>";
        }
      ...
      if(this.endPage < this.totalPages){
        ...
        pagingArea2 += "<nav class='wf-pagination-wrap'> ";
        pagingArea2 += "<ul class='pagination'> ";
        pagingArea2 += "<li class='page-item'> ";
        pagingArea2 += "<a class='page-link prev' ";
        if (this.startPage < 5) { pagingArea2 += "style='pointer-events: none;'"; }
        pagingArea2 += " href='javascript:getDutyListCnfirmDate(" + (this.startPage-4) + ", " + keyword + ")'>";
        pagingArea2 += "<i class='xi-angle-left'></i> ";
        pagingArea2 += " </a>";
        pagingArea2 += "</li>";
        ...
        pagingArea2 +="'>";
        pagingArea2 += "<a class='page-link' href='javascript:getDutyListCnfirmDate(" + pNo + ", " + keyword + ")'>" + pNo + "</a>";	
        pagingArea2 += "</li>";
        }
        // 페이지가 5개 미만일 경우 오른쪽 화살표 제거
      if(this.endPage < this.totalPages){
        pagingArea2 += "<li class='page-item'> ";
        pagingArea2 += "<a class='page-link next ";
        pagingArea2 += "' href='javascript:getDutyListCnfirmDate(" + (this.startPage+4) + ", " + keyword + ")'>";
        pagingArea2 += "<i class='xi-angle-right'></i>  ";
        pagingArea2 += "</a>";
        pagingArea2 += "</li>";
      }
        pagingArea2 += "</ul> ";
   ...
   public void setPagingArea(String pagingArea) {
	...
	public void setPagingArea2(String pagingArea2) {
		this.pagingArea2 = pagingArea2;
	}
