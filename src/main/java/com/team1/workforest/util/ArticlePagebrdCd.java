...
public class ArticlePagebrdCd<T> {
   // 전체 글 수
   private int total;
   // 현재 페이지 번호
   ...
   public ArticlePagebrdCd(int total, int currentPage, int size, List<T> content, String keyword, String searchOption,String brdCd) {
      ...
      pagingArea += "<nav class='wf-pagination-wrap'> ";
        ...
        pagingArea +=  "' href='"+this.url + "?currentPage='"+
              (this.startPage - 5) + "&searchOption="+this.searchOption+"&keyword=" + this.keyword+"&brdCd="+this.brdCd+ "'>";
        ...
        pagingArea += "<a class='page-link' href='" + this.url + "?currentPage=" + pNo + "&searchOption="+this.searchOption+"&keyword=" + 
                            this.keyword +"&brdCd="+this.brdCd+"'>"+pNo+"</a>";
        pagingArea += "</li>";
        }
      ...
      if(this.endPage < this.totalPages){
        ...
        pagingArea += "' href='"+this.url+"?currentPage="+(this.startPage+5)+"&searchOption="+this.searchOption+"&keyword="+this.keyword+"&brdCd="+this.brdCd+"'>  ";
