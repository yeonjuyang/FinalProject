...
public class ArticlePageSearchOption<T> {
   // 전체 글 수
   private int total;
   // 현재 페이지 번호
   ...
   public ArticlePageSearchOption(int total, int currentPage, int size, List<T> content, String keyword, String searchOption) {
      ...
      pagingArea += "<nav class='wf-pagination-wrap'> ";
        ...
        pagingArea +=  "' href='"+this.url + "?currentPage='"+
              (this.startPage - 5) + "&searchOption="+this.searchOption+"&keyword=" + this.keyword+"'>";
      ...
      if(this.endPage < this.totalPages){
        ...
        pagingArea += "' href='"+this.url+"?currentPage="+(this.startPage+5)+"&searchOption="+this.searchOption+"&keyword="+this.keyword+"'>  ";
