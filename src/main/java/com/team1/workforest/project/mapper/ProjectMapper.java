...
public interface ProjectMapper {
	...
	public ProjectVO getStart(ProjectVO vo);

	public int getStartUpdate(ProjectVO vo);


	public int updateLeaderFirst(ProjectVO vo);

	public int updateLeaderLast(ProjectVO vo);

	public ProjectVO getProjectDone(ProjectVO vo);
