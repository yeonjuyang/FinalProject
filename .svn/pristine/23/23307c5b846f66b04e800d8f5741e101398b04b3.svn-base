...
<div class="wf-content-wrap">
    <div class="approval-create-wrap wf-flex-box">
		<div class="wf-content-area left" data-aos="fade-right" data-aos-duration="700" data-aos-delay="200">
        ...
        <div class="wf-content-area right" data-aos="fade-right" data-aos-duration="700" data-aos-delay="400">
            <div class="approval-write-box">
                ...
                <ul class="approval-add-user bul-lst01 no-data" id="apv_line1"></ul>
            </div>
            <div class="approval-write-box">
                <div class="tit-wrap">
                ...
                <ul class="approval-add-user bul-lst01 no-data" id="apv_line2"></ul>
            </div>
            <div class="approval-write-box">
                <div class="tit-wrap">
               ...
               <div class="tab-type tab-type1">
                   ...
                   <div data-tab="tab1" class="tab-content active">
                       <div class="tab-board-lst" style="height: 560px;">
                           <ul id="MODAL_BKMK_LIST" class="bookmark-list bul-lst01"></ul>
                       </div>
                   </div>
                ...
                <div class="right">
           			<div class="line-top"><i class="xi-bell"></i>결재선은 기안>검토>결재 순으로 설정해주세요</div>
                    <ul id="MODAL_APV_LINE_LIST" class="approval-add-user line bul-lst01 line-no-data"></ul>
                </div>
            </div>
        </div>
