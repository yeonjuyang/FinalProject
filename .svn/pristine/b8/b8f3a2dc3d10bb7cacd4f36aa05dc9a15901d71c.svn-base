...
function emailDetail(emailNo,prevMailNo,nextMailNo){
	   window.location.href = '/mail/detail/attachbox/' + emailNo
...
$(document).ready(function(){
	...
	$("#delBtn").click(function(){
		...
		$.ajax({
			type: "POST",
			url: "/mail/delete/attachbox", // 삭제 요청을 처리할 서버 측 URL
	...
	<div class="wf-mail-right">
		...
		<div class="wf-content-area getmail">
			<div class="wf-flex-box between mg-b-10">
				<h1 class="page-tit2">
					<i class="xi-mail"></i> 첨부파일이 있는 메일 <span class="mail-badge">${attachCount}</span>
				</h1>
