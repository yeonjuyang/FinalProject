...
public class ArticlePageForProject<T> {
    // 전체글 수
    private int total;
    // 현재 페이지 번호
    ...
    public ArticlePageForProject(int total, int currentPage, int size, List<T> content,
        ...
        pagingArea += "<a class='page-link prev ";
		  ...
		  if (this.startPage < 5) { pagingArea += "disabled"; }
		 
        pagingArea += "' href='"+this.url + "?currentPage="+
        		(this.startPage - 4) + "&keyword=" + this.keyword+"'>";
        ...
        pagingArea +="'>";
        pagingArea += "<a class='page-link' href='" + this.url + "?currentPage=" + pNo + "&keyword=" + 
        		              this.keyword + "'>"+pNo+"</a>";
        pagingArea += "</li>";
        }
        pagingArea += "<li class='page-item'> ";
        ...
        pagingArea += "' href='"+this.url+"?currentPage="+(this.startPage+4)+"&keyword="+this.keyword+"'>  ";
