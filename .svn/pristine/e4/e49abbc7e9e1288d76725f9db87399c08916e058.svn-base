package com.team1.workforest.admin.chart.vo;
...
public class adminEmpVO { //사원
	...
	private String workState; //근무위치지역명
	private int count;
	
	
	public adminEmpVO(String empNo, String empPw, String empNm) {
		this.empNo= empNo;
		this.empPw= empPw;
		this.empNm= empNm;
	}
